	...
	var data = [
			...
			var chart = new iChart.LineBasic2D({
				...
				tip:{
					...
					listeners:{
						...
						parseText:function(tip,name,value,text,i){
							return "</span><span style='color:#005268;font-size:30px;'>"+value+name+"</span>";
						}
					}
				},
				crosshair:{
				...
				coordinate:{
					...
					scale:[{
						 position:'left',	
						 start_scale:ystart_scale,//纵坐标起始值
						 end_scale:10,
						 scale_space:ystart_scale,
						 scale_size:10,
						 scale_enable : false,
						 label : {color:'#9d987a',font : '微软雅黑',fontsize:25,fontweight:600},
						 scale_color:'#9f9f9f'
					},{
						 position:'bottom',	
						 label : {color:'#9d987a',font : '微软雅黑',fontsize:xbsize,fontweight:600},
						 scale_enable : false,
						 labels:labels
					}]
				}
