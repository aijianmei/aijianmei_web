 ...
 * @version $Id: WindidAvatarApi.php 28968 2013-05-31 12:05:48Z gao.wanggao $
...
class WindidAvatarApi {
	...
	public function doAvatar($uid, $file = '') {
		...
		$query = array(
			...
			'c' => 'avatar',
			'a' => 'doavatar',
			'windidkey' => WindidUtility::appKey(WINDID_CLIENT_ID, $time, WINDID_CLIENT_KEY, array('uid' => $uid)),
