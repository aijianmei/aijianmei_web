...
原创内容',
			...
			'task.isOpen' => '1',
			'medal.isopen' => '1',
			'homeUrl' => 'index.php?m=bbs&c=forumlist',
			'windid' => 'local',
			'homeRouter' => array(
				'm' => 'bbs',
				'c' => 'forumlist',
			...
			'avatarUrl' => 'http://www.kon_aijianmei.com/forum/windid/attachment',
			'hash' => '4wTRzHGs',
			'cookie.pre' => 'ghL',
			'info.mail' => 'admin@phpwind.com',
			'info.url' => 'http://www.kon_aijianmei.com/forum',
...
3:地板',
		...
		'nav' => array(
			'main' => array(
				'0' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=bbs">论坛</a>',
					'sign' => 'bbs|index|run|',
				),
				'1' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=bbs&c=forumlist">版块</a>',
					'sign' => 'bbs|forumlist|run|',
				),
				'2' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=like&c=like">喜欢</a>',
					'sign' => 'like|like|run|',
				),
				'3' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=tag">话题</a>',
					'sign' => 'tag|index|run|',
				),
			),
			'bottom' => array(
			...
			'my' => array(
				'0' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=space"><em class="icon_space"></em>我的空间</a>',
					'sign' => 'space',
				),
				'1' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=my&c=fresh"><em class="icon_fresh"></em>我的关注</a>',
					'sign' => 'fresh',
				),
				'2' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=bbs&c=forum&a=my"><em class="icon_forum"></em>我的版块</a>',
					'sign' => 'forum',
				),
				'3' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=my&c=article"><em class="icon_article"></em>我的帖子</a>',
					'sign' => 'article',
				),
				'4' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=vote&c=my"><em class="icon_vote"></em>我的投票</a>',
					'sign' => 'vote',
				),
				'5' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=task"><em class="icon_task"></em>我的任务</a>',
					'sign' => 'task',
				),
				'6' => array(
					'name' => '<a href="http://www.kon_aijianmei.com/forum/index.php?m=medal"><em class="icon_medal"></em>我的勋章</a>',
					'sign' => 'medal',
				),
			),
		),
		'windid' => array(
			'windid' => 'local',
			'serverUrl' => 'http://www.kon_aijianmei.com/forum/windid',
			'clientId' => '1',
			'clientKey' => 'df8107b0f73281d924d75a6fead52e40',
			'connect' => 'db',
		),
	),
	'expires' => '0',
