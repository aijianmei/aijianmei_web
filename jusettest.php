...
# with ServerRoot set to "D:/usr/local/apache2" will be interpreted by the
# server as "D:/usr/local/apache2/logs/foo.log".
#
...
<IfModule alias_module>
    ...
    # Example:
    # Redirect permanent /foo http://www.njhoo.com/bar
    ...
    #
    ScriptAlias /cgi-bin/ "D:/usr/local/apache2/cgi-bin/"
...
#ErrorDocument 402 http://www.njhoo.com/subscription_info.html
#
...
# 索引文件
<IfModule mod_dir.c>
    DirectoryIndex index.html index.htm index.php install.php
</IfModule>
AcceptPathInfo On 
#Hidden php
...
LoadModule php5_module "D:\usr\local\php5\php5apache2_2.dll"
